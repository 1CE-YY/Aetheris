...
import com.aetheris.rag.dto.response.ErrorResponse;
...
public class GlobalExceptionHandler {
    ...
    public ResponseEntity<ErrorResponse> handleBaseException(BaseException ex, HttpServletRequest request) {
        ...
        ErrorResponse response = ErrorResponse.withPath(ex.getCode(), ex.getMessage(), path);
    ...
    public ResponseEntity<ErrorResponse> handleValidationException(MethodArgumentNotValidException ex, HttpServletRequest request) {
        ...
        String path = request.getRequestURI();
        ErrorResponse response = ErrorResponse.of("VALIDATION_ERROR", "参数校验失败", errors.toString(), path);
    ...
    public ResponseEntity<ErrorResponse> handleTypeMismatchException(MethodArgumentTypeMismatchException ex, HttpServletRequest request) {
        ...
        String path = request.getRequestURI();
        ErrorResponse response = ErrorResponse.withPath(
                "TYPE_MISMATCH",
    ...
    public ResponseEntity<ErrorResponse> handleIllegalArgumentException(IllegalArgumentException ex, HttpServletRequest request) {
        ...
        String path = request.getRequestURI();
        ErrorResponse response = ErrorResponse.withPath("ILLEGAL_ARGUMENT", ex.getMessage(), path);
    ...
    public ResponseEntity<ErrorResponse> handleUnhandledException(Exception ex, HttpServletRequest request) {
        ...
        String path = request.getRequestURI();
        ErrorResponse response = ErrorResponse.of("INTERNAL_ERROR", "服务器内部错误", ex.getMessage(), path);
